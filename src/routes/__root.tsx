...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "VDesigns Interiors — Luxury Interior Design Studio in Kerala" },
      { name: "description", content: "VDesigns Interiors is a premium interior design studio in Perinthalmanna, Kerala — crafting elegant residential, commercial, and luxury villa interiors across India." },
      { name: "author", content: "VDesigns Interiors" },
      { property: "og:title", content: "VDesigns Interiors — Luxury Interior Design Studio in Kerala" },
      { property: "og:description", content: "VDesigns Interiors is a premium interior design studio in Perinthalmanna, Kerala — crafting elegant residential, commercial, and luxury villa interiors across India." },
